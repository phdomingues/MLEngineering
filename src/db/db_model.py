...
specifically rental apartments. The model uses SQLAlchemy's
...
class RentApartments(Base):
    ...
    Attributes:
        ...
        area (float): The area of the apartment in squared meters.
        ...
        storage (str): Information about the storage space.
        parking (str): Information about the parking availability.
